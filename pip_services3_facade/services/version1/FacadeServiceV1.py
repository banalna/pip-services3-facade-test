...
from pip_services3_facade.operations.version1.BeaconsOperations import BeaconsOperations
...
class FacadeServiceV1(RestService):
    ...
    def register_beacons_routes(self):
        ...
        self.register_route('put', '/beacons/<id>', None, self._beacons_operations.update)
